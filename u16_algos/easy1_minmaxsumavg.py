...
print("The fastest swimmer is in lane" , countf , "with a time of " , fastest )
print("The slowest swimmer is in lane" , counts , "with a time of " , slowest )
...
for i in donations:
    print(i) # key
    print(donations[i]) # value
    # if i < lowest:
    #     lowest = i
    # if i > highest:
    #     highest = i

print(f"The highest amount donated is by {classh} with an amount of {highest}")
print("The highest amount donated is by " , classh , "with a amount of " , highest)
print("The lowest amount donated is by " , classl , "with a amount of " , lowest)
...
averagesales = sumsales / len(daily_sales)



print(f"The total sales for the month is  {sumsales}  and the average is {averagesales}")
...
hotest = hourly_temperatures[0]
coolest = hourly_temperatures[0]
timeh = 0
timec = 0
timeidx = 0
...
print(f"The hotest temperature recorded was {hotest} °C at {timeh}00 ")
print(f"The coolest temperature recorded was {coolest} °C at {timec}00 ")
...
for i in exam_scores:
    sumscore += exam_scores[i]

averagescore = sumscore / len(exam_scores)


print(f"The average score of the class is {averagescore}")


for i in exam_scores:
    if exam_scores[i] < 50 :
        failed_students[i] = exam_scores[i]
